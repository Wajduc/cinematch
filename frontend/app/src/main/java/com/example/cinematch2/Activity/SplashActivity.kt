...
fun FooterSection(onGetInClick: () -> Unit) {
    Box(
        ...
        Button(
            ...
            Text(text = "Start Watching", fontSize = 18.sp, color = Color.White)
        }
    }
}
...
fun HeaderSection() {
    Box(
        ...
        Column(
            ...
            Image(painter = painterResource(id = R.drawable.cinematch_logo_circle),
                contentDescription = null, modifier = Modifier.size(400.dp)
            )
            Spacer(modifier = Modifier.height(32.dp))
            Text(
                text="Welcome to CineMatch", style = TextStyle(
                color = Color.White,
                fontSize = 40.sp,
            ...
            Text(
                text="Watch movies offline", style = TextStyle(
                    color = Color.White,
                    fontSize = 18.sp,
                    textAlign = TextAlign.Center
                )
